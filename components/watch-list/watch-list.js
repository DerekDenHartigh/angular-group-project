...
.component('watchList', {
    ...
    <div id="watchlist-container">
        ...
        <img class="movie-poster image" alt="movie poster" ng-src="{{movie.poster}}" ng-click="show=!show" fallback-src="https://www.kargomaster.com/pub/media/catalog/product/placeholder/default/sorry-image-not-available.jpg"></img>
